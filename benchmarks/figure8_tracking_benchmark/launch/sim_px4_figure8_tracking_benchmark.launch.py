...
def generate_launch_description() -> LaunchDescription:
    ...
    config = trajectory_share / "config" / "px4_figure8_trajectory.yaml"
    trajectory = Node(
    ...
    reporter = Node(
        ...
        parameters=[
            LaunchConfiguration("trajectory_config_file"),
            {
                "use_sim_clock": True,
                "sim_clock_topic": "/acesim/clock",
                "report_type": "px4_figure8",
                "benchmark_name": "px4_figure8_tracking_benchmark",
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument("trajectory_config_file", default_value=str(config)),
