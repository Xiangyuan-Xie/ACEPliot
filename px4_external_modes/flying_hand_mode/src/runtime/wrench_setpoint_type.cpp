...
{
  thrust_topic_ = joinTopicPrefix(
    context.topicNamespacePrefix(), "/fmu/in/vehicle_thrust_setpoint") +
    px4_ros2::getMessageNameVersion<px4_msgs::msg::VehicleThrustSetpoint>();
  torque_topic_ = joinTopicPrefix(
    context.topicNamespacePrefix(), "/fmu/in/vehicle_torque_setpoint") +
