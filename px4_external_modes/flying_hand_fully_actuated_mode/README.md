...
`flying_hand_fully_actuated_mode` reconstructs the low-level architecture
...
```yaml
flying_hand_fully_actuated_mode:
  ros__parameters:
    closed_loop: true
...
`tools/requirements-codegen.txt`; normal deployment does not require Python,
