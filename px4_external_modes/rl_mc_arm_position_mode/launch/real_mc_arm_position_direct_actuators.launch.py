...
def generate_launch_description() -> LaunchDescription:
    ...
    config_file = os.path.join(
        pkg_rl_mc_arm_position_mode, 'config', 'real_mc_arm_position_direct_actuators.yaml')
    ...
    config_file_arg = DeclareLaunchArgument(
        'config_file', default_value=config_file, description='YAML config file for real direct actuators launch')
    ...
    position_mode_node = Node(
        ...
        executable='rl_mc_arm_position_direct_actuators_mode',
        parameters=[{
